...
const form = reactive({full_name:'',company_name:'',email:'',role:'repairer',password:'',phone:'',abn:'',address_line1:'',city:'',state_region:'',postcode:'',country_code:'AU'})
...
const register = async () => {
  ...
  try {
    ...
    if (data.session) {
      ...
      return navigateTo(form.role === 'supplier' ? '/supplier/dashboard' : '/repairer/dashboard')
    }
